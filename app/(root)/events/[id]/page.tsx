...
const page = async ({ params: { id }, searchParams }: SearchParamProps) => {
  ...
  const relatedEvents = await getRealtedEventsByCategory({
  ...
  return (
    <>
      <section className="flex justify-center bg-primary-50 bg-dotted-pattern bg-contain tes">
